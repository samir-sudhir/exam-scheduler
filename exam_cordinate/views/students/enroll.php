<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_course'])) {
        ...
        $stmt_prepare = $mysqli->prepare($stmt_course);
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload'])){
        ...
        if($file) {
            ...
            $enroll_prepare = $mysqli->prepare($enroll_query);
...
<body class="bg-light">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $execute_courses = $mysqli->query($select_course);
    ...
    <script type="text/javascript">
        ...
        // $('#course_code_delete').select2({
        //     ajax: {
        //         url: 'search_courses.php', // PHP file to search courses
        //         dataType: 'json',
        //         delay: 250,
